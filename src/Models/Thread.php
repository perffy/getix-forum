...
class Thread extends BaseModel
{
	...
	public function countries() {
		...
		return $this->belongsToMany('App\Models\Country', 'forum_thread_country_relation');

    }
	
	public function thread_countries() {
		
		return $this->belongsToMany('App\Models\ForumThreadCountry', 'forum_thread_country_relation', 'thread_id', 'id');
